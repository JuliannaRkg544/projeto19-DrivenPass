...
function createNote(title, description, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var notes, noteTitles, notedata;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, noteRepository.searchAllNotes(userId)];
                case 1:
                    notes = _a.sent();
                    if (notes.length > 0) {
                        noteTitles = notes.map(function (note) {
                            return note.title;
                        });
                    ...
                    return [4 /*yield*/, noteRepository.createNote(notedata)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
function searchAllNotes(userId) {
    return __awaiter(this, void 0, void 0, function () {
        var notes;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function searchNoteById(noteId) {
    return __awaiter(this, void 0, void 0, function () {
        var note;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, noteRepository.searchNoteById(noteId)];
                case 1:
                    note = _a.sent();
                    if (!note) {
